...
Búsqueda Local Dinámica (\emph{Dynamic Local Search} o \emph{DLS}) es
una metaheurística presentada por [referencia], basada en la
...
como $N_I(C_{k-1})$. La fase de intensificación termina cuando
$N_I(C_{k-1}) = \emptyset$.

Una vez $N_I(C_i) = \emptyset$, la búsqueda \emph{plateau} consiste en
el intercambio de un vértice $v \in C_i$ por un vértice $v' \in
N_L(C_i)$
